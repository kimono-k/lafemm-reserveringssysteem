  ...
  <svg style="display: none;">
    ...
    <div class="col-container">
        ...
        <a class="logo" href="./">
          ...
          <span class="logo-name">La Femm Reserveringssysteem</span>
        </a>
      </h1>

  		<ul class="nav">
        <li class="nav-item tasks<?php if ($page == "tasks") { echo " on"; } ?>"><a class="nav-link" href="task_list.php">Mijn afspraken</a></li>
        <li class="nav-item projects<?php if ($page == "projects") { echo " on"; } ?>"><a class="nav-link" href="project_list.php">Behandelingen toevoegen</a></li>
        <li class="nav-item reports<?php if ($page == "reports") { echo " on"; } ?>"><a class="nav-link" href="reports.php">Afrekenen</a></li>
      </ul>
    </div>
  </header>
	<div id="content">
